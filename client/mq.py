...
class MQ():
    ...
    MQ_PIN                       = 6        # define which analog input channel you are going to use (MCP3008)
    ...
    def MQCalibration(self):
        ...
        for i in range(self.CALIBARAION_SAMPLE_TIMES):          # take multiple samples
            val += self.MQResistanceCalculation(mcp.read_adc(6))
    ...
    def MQRead(self):
        ...
        for i in range(self.READ_SAMPLE_TIMES):
            rs += self.MQResistanceCalculation(mcp.read_adc(6))
